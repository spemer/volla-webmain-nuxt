...
import { globalVar } from '~/assets/js/globalVar.js'
...
export const state = () => ({
  ...
  snsList: {
    facebook: [globalVar.facebookUrl, 'fa-facebook-square', '페이스북'],
    instagram: [globalVar.instagramUrl, 'fa-instagram', '인스타그램'],
    appstore: [globalVar.iosStore, 'fa-app-store-ios', '앱 스토어 다운받기'],
    android: [globalVar.androidStore, 'fa-google-play', '구글 플레이 다운받기']
  },
  ...
  benefits: {
    top: {
      benefits_1:
        '입점비용이 없습니다. 상품만 있다면 누구나 온라인 셀러가 될 수 있습니다.',
      benefits_2:
        '매출 수수료는 당연히 타 업체들과 비교했을 때에도, 더욱 더 저렴합니다.',
      benefits_3:
        '전문장비가 없어도 스마트폰만으로 쉽게 라이브 방송을 시작할 수 있습니다.'
    },
    bottom: {
